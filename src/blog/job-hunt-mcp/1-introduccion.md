---
title: 'Organizando mi búsqueda de empleo con un MCP'
pubDate: 2026-09-10
description: 'Presento un servidor MCP construido con Spring AI para registrar postulaciones, analizar mis brechas técnicas y preparar entrevistas a partir de los requisitos de cada oferta.'
image:
...
Buscar trabajo como desarrollador no consiste únicamente en enviar currículums. Después de varias postulaciones empiezan a mezclarse las empresas, las versiones del CV, los requisitos de cada oferta y el estado de cada proceso. Preparar una entrevista técnica añade otra capa de trabajo: hay que volver a leer la descripción, identificar las tecnologías importantes y decidir qué temas conviene repasar.

Por eso he decidido construir una herramienta que me ayude a organizar mi búsqueda de empleo mientras aprendo sobre **MCP**, **Spring AI** y las aplicaciones con modelos de lenguaje. La idea es crear un copiloto de postulaciones que pueda consultar desde Claude Desktop, Cursor u otro cliente compatible.
...
> Acabo de enviar mi CV a una oferta de Backend en MercadoLibre. Guarda el texto de la oferta y marca la postulación como aplicada.
...
> Muestra el embudo de mis postulaciones este mes y las tecnologías que más se repiten en las ofertas que me han rechazado.
...
La primera versión será sencilla: registrar ofertas, guardar en qué punto está cada proceso y comparar los requisitos de una oferta con mis conocimientos. Con eso ya podré detectar qué habilidades debería reforzar antes de una entrevista o de una nueva tanda de postulaciones.
...
No busco construir una solución enorme desde el primer día. Prefiero empezar con una base útil, probarla con mis propias postulaciones y mejorarla a medida que entienda qué información necesito de verdad.
